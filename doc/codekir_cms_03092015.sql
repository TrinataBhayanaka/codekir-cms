...
--
-- Host: localhost
-- Generation Time: Sep 03, 2015 at 03:07 PM
...
CREATE TABLE IF NOT EXISTS `ck_menu` (
  ...
  `title_menu` varchar(25) NOT NULL,
...
INSERT INTO `ck_menu` (`id_menu`, `parent_id`, `ordering`, `title_menu`, `type_link`, `link_menu`, `n_status`) VALUES
(1, 0, 1, 'Home', 0, 'home', 1),
(2, 0, 3, 'profile', 0, 'profile', 1),
(3, 0, 7, 'blog', 0, 'blog', 1),
(4, 0, 5, 'contact', 0, 'contact', 1),
(5, 3, 8, 'blog-single', 0, 'blog', 1),
(6, 0, 6, 'blog-doble', 0, 'contact', 1),
(7, 0, 2, 'Galery', 0, 'blog', 1),
(8, 0, 9, 'Blog -grid', 0, 'blog', 1),
(9, 2, 4, 'Companay', 0, 'page/?id=17', 1);
...
CREATE TABLE IF NOT EXISTS `ck_news_content` (
  ...
  `articleType` int(11) NOT NULL COMMENT '1:page,2:blog',
...
--
-- Dumping data for table `ck_news_content`
--

INSERT INTO `ck_news_content` (`id`, `parentid`, `lid`, `title`, `brief`, `content`, `image`, `thumbnail_image`, `slider_image`, `categoryid`, `articleType`, `url`, `sourceurl`, `file`, `created_date`, `expired_date`, `posted_date`, `fromwho`, `filesize`, `can_save`, `tags`, `authorid`, `n_status`, `topcontent`) VALUES
(16, 0, 0, 'blog', '', '&lt;p&gt;sdfndsjnf&lt;br&gt;&lt;/p&gt;', '', NULL, '', 0, 1, '', '', '4fe766573797509c1ff9718be9982d67.jpg', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 0, 0, NULL, 0, 0, 0),
(17, 0, 0, 'Profile', '', '&lt;p&gt;sdfndsfjngjds&lt;br&gt;&lt;/p&gt;', '', NULL, '', 0, 1, '', '', '68cda127adc9f765b2200ce04e6f5601.jpg', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 0, 0, NULL, 0, 0, 0);
...
--
-- Table structure for table `ck_options`
--

CREATE TABLE IF NOT EXISTS `ck_options` (
...
--
-- Dumping data for table `ck_options`
--

INSERT INTO `ck_options` (`option_id`, `option_name`, `option_value`, `n_status`) VALUES
(1, 'current_theme', 'bonfire2', 1);
